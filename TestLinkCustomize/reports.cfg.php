...
// Test Suite Customize follow Tflat
$tlCfg->reports_list['results_suite'] = array(
	'title' => 'custom_link_report_suite',
	'url' => 'lib/results/cus_printTestSuite.php',
	'enabled' => 'all',
    'format' => 'format_html,format_mail_html'
);

// Test Type Customize follow Tflat
$tlCfg->reports_list['results_testType'] = array(
    'title' => 'custom_link_report_test_type',
    'url' => 'lib/results/cus_printTestType.php',
    'enabled' => 'all',
    'format' => 'format_html,format_mail_html'
);
