...
{if $gui->printDate == ''}
    <form name="resultsTC" id="resultsTC" METHOD="POST"
          ...
          action="lib/results/cus_resultTestType.php?format=3&do_action=result&tplan_id={$gui->tplan_id}&tproject_id={$gui->tproject_id}&buildListForExcel={$gui->buildListForExcel}&build_id={$build_id}">
